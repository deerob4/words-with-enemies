defmodule WordsWithEnemies.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule WordsWithEnemies.MyChannel do
        use WordsWithEnemies.Web, :channel
        alias WordsWithEnemies.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :words_with_enemies,
                        pubsub_server: WordsWithEnemies.PubSub
end
